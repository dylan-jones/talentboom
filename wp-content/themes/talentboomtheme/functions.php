...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('html5blankscripts', get_template_directory_uri() . '/dist/bundle.min.js', array('jquery'), '1.0.0'); // Custom scripts
...
function html5blank_styles()
{
    ...
    wp_register_style('html5blank', get_template_directory_uri() . '/dist/styles.min.css', array(), '1.0', 'all');
...
function cptui_register_my_cpts_connection() {
    $labels = array(
        "name" => __( "Connections", "" ),
    ...
    $args = array(
        ...
        "map_meta_cap" => true,
        "hierarchical" => false,
        "rewrite" => array( "slug" => "connection", "with_front" => true ),
        "query_var" => true,
...
add_action( 'init', 'cptui_register_my_cpts_connection' );
