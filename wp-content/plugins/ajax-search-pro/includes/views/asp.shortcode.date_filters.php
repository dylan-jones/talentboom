...
if ( isset($style['_fo']) && isset($style['_fo']['post_date_from']) ) {
    $_dff_v = sanitize_text_field($style['_fo']['post_date_from']);
    $_dft_v = sanitize_text_field($style['_fo']['post_date_to']);
} else {
...
<fieldset>
    <?php if ( $_dff['state'] != 'disabled' ): ?>
        ...
        <textarea class="asp_datepicker_format"
                  aria-hidden="true"
                  style="display:none !important;"><?php echo $style["date_filter_from_format"]; ?></textarea>
        <input type="text"
               aria-label="<?php echo asp_icl_t( "Post date filter: Content from" . " ($real_id)", $_dfrom_t, true ); ?>"
               class="asp_datepicker" name="post_date_from_real" value="<?php echo $_dff_v; ?>">
    ...
    <?php if ( $_dft['state'] != 'disabled' ): ?>
        ...
        <textarea class="asp_datepicker_format"
                  aria-hidden="true"
                  style="display:none !important;"><?php echo $style["date_filter_to_format"]; ?></textarea>
        <input type="text"
               aria-label="<?php echo asp_icl_t( "Post date filter: Content to" . " ($real_id)", $_dto_t, true ); ?>"
               class="asp_datepicker" name="post_date_to_real" value="<?php echo $_dft_v; ?>">
