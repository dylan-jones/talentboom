...
<?php if ($style['fe_search_button'] == 1): ?>
    <?php if ($use_compatibility == true): ?>
        <?php echo $asp_set_ids1; ?>.searchsettings fieldset.asp_s_btn_container,
        <?php echo $asp_set_ids2; ?>.searchsettings fieldset.asp_s_btn_container,
        <?php echo $asp_bset_ids1; ?>.searchsettings fieldset.asp_s_btn_container,
        <?php echo $asp_bset_ids2; ?>.searchsettings fieldset.asp_s_btn_container,
    <?php endif; ?>
    <?php echo $asp_set_ids; ?>.searchsettings fieldset.asp_s_btn_container,
    <?php echo $asp_bset_ids; ?>.searchsettings fieldset.asp_s_btn_container {
